OctToDec. PHP Tutorials. Simple Input/Output. Strings. Algorithms. Console Application. 
A console application in the PHP programming language. 
The program does the following:
  1. Asks the user to enter a string.
  2. Checks whether the entered string is valid. It must be less than 32 characters long and contain only the numbers between 0 and 7.
  ...
  5. The loop with the parameter is executed.
    ...
    5.2. A series of cycles is performed.
      ...
      5.2.4. The variable of the factor of power 8 is multiplied by 8, since the number is binary.
...
OctToDec. Занятия по PHP. Простой Ввод/вывод. Строки. Алгоритмы. Консольное приложение.
...
Программа делает следующее:
  ...
  5. Выполняется цикл с параметром.
     ...
     5.2. Выполняется серия цикла.
          5.2.1. Выисляется код очередного символа строки. Он переводится либо в число от 0 до 7.
